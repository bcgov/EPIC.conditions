          ...
          "properties": {
            ...
            "requires_report": {
              ...
              "description": (
                  ...
                  "submit (that report is a distinct requirement — do not let the IEM's own retention/terms "
                  "language cause an extra, duplicate report entry to be created). Mark False for a "
