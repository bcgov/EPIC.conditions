...
setup(
    name="condition",
    version="0.1",
    packages=find_packages(),  # Finds packages in the root directory
    py_modules=[splitext(basename(path))[0] for path in glob('*.py')],  # Includes Python modules in the root directory
