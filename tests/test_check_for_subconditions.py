...
condition_text_1="The Proponent must provide any document, data or information requested by EAO for the purposes of compliance inspection and verification."

condition_text_2="""he Proponent must notify EAO Compliance and Enforcement, in writing, at least 14 days prior to commencing Construction. 
Should the primary contact person for the Project change, the Proponent must notify EAO (to the attention of EAO Compliance and Enforcement), in writing, within 30 days of such change and provide the physical address, email address and phone number(s) of the new primary contact person."""
...
@pytest.mark.parametrize("input_string,expected", [
    (condition_text_1, False),
    (condition_text_2, False),
    (condition_text_3, True),
])
