...
function ConditionPage() {
  ...
  useEffect(() => {
    if (conditionDetails) {
      replaceBreadcrumb(META_PROJECT_TITLE, conditionDetails?.project_name || META_PROJECT_TITLE);
      ...
      replaceBreadcrumb(
        ...
        `/conditions/project/${conditionDetails.project_id}/document/${conditionDetails.document_id}/`
      );
    }
