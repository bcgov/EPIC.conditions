          ...
          "properties": {
              "conditions": {
                ...
                "items": {
                    "type": "object",
                    "properties": {
                        "condition_name": {"type": "string", "description": "The name associated with the condition. Is null if not explicitly mentioned."},
                        "condition_number": {"type": "integer", "description": "The number associated with the condition. Is null if not explicitly mentioned."},
                    ...
                    "required": ["condition_name", "condition_text", "condition_number"],
                },
            ...
            "properties": {
                  ...
                  "clauses": {
                      ...
                      "items": {
                          "type": "object",
                          "properties": {
                              "clause_identifier": {"type": "string", "description": "The number, letter, or other identifier of the clause. E.g. 1), 1 a), i, etc. Write it exactly as it appears in the text (i.e. include brackets). If none, leave blank. Typically blank for the outermost clause."},
                              "clause_text": {"type": "string", "description": "The text of the clause before the subconditions."},
                              "subconditions": {
                                  "type": "array",
                                  "items": {
                                      "type": "object",
...
def extract_all_subconditions(input_json):
  ...
  for condition in input_json["conditions"]:
    ...
    condition["clauses"] = json.loads(subcondition)["clauses"]
